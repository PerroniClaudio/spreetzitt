...
class ProjectReportUpdatedNotification extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Report di progetto disponibile o aggiornato',
        );
    }
    ...
    public function build()
    {
        return $this->withSymfonyMessage(function ($message) {
            $message->getHeaders()->addTextHeader('X-Project-Report-ID', $this->report->id);
        });
    }
    ...
    {
        return new Content(
            markdown: 'emails.report.project-updated',
        );
    }
