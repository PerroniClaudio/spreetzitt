    ...
    private function getBillingCounters(): array
    {
        ...
        $result = DB::selectOne('
            SELECT 
                ...
                COUNT(CASE WHEN is_billed = 1 AND invoice_id IS NULL THEN 1 END) as billed_invoice_id_missing,
                ...
                COUNT(CASE WHEN is_billed = 1 AND invoice_id IS NULL AND stage_id != ? THEN 1 END) as open_billed_invoice_id_missing,
        ...
        return [
            ...
            'billed_invoice_id_missing' => $result->billed_invoice_id_missing,
            ...
            'open_billed_invoice_id_missing' => $result->open_billed_invoice_id_missing,
