...
class GenerateReport implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try {
            ...
            Excel::store(new TicketsExport($this->report->company_id, $this->report->start_date, $this->report->end_date, $this->report->id), 'exports/'.$this->report->company_id.'/'.$this->report->file_name, $disk);
